...
export function GlassesIcon({ className = 'h-5 w-5', ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M6 15a3 3 0 100-6 3 3 0 000 6zm12 0a3 3 0 100-6 3 3 0 000 6zM12 15a2 2 0 01-2-2 2 2 0 012-2m0 0a2 2 0 012 2 2 2 0 01-2 2M3 8l2.5 5c.5 1 1.5 2 3 2m10.5-7L19 13c-.5 1-1.5 2-3 2"
      />
    </svg>
  );
}

export function FilterIcon({ className = 'h-6 w-6', ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
