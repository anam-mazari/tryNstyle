      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
          <div className="flex h-16 shrink-0 items-center">
            <h1 className="text-xl font-bold text-white">TrynStyle Admin</h1>
          </div>
      ...
      {isMobileOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="fixed inset-y-0 left-0 z-50 w-72 bg-gray-900">
            <div className="flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-800 px-4 shadow-sm sm:px-6">
              <h1 className="text-xl font-bold text-white">TrynStyle Admin</h1>
              <button
                type="button"
